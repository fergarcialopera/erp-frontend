...
export function LandingHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-navy-950/80 backdrop-blur-[18px]">
      <nav className="ll-container flex min-h-[76px] items-center justify-between gap-6">
        <a href="#inicio" className="inline-flex items-center gap-2.5 text-white">
          <img
        ...
        <Button asChild variant="onDark" size="sm" className="shrink-0">
